...
class SemanticTableDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        #print("x1",x1_semantic)
        #print("x2",x2_semantic)
        ...
        return x1_final_features, x2_final_features, agg_features, x1_semantic_tensor, x2_semantic_tensor, gr_t
            ...
            if os.path.isfile(single_file_path):    
                ...
                for key in ground_truth.adj_matrices:
                    if key in single_file_path:
                        gtruth =[]
                        df = ground_truth.adj_matrices.get(key)
                        for (col1_in, col2_in) in index_combina:
                            element = df.iloc[col1_in, col2_in]
                            gtruth.append(element)
...
if __name__ == '__main__':
    ...
    x1_final_features, x2_final_features, agg_features, agg_features_dataset, x1_semantic_tensor, x2_semantic_tensor, gr_t= next(
